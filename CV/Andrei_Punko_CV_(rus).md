...
- Не интересны проекты, связанные с азартными играми, forex, казино или другой аморальной активностью
...
- Участвовал в миграции системы контроля версий из Perforce в Git и настройке CI после этого (jobs, pipelines,
  notifications)
...
- Адаптация существующих/разработка новых компонентов пользовательского интерфейса для двух приложений (с использованием
  GWT)
- Добавление поддержки второго (китайского) языка в существующем пользовательском интерфейсе с возможностью перевода с
  английского
